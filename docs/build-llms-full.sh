...

{
  ...
  echo
  echo "Each skill carries layered knowledge: the instructions below, bundled"
  echo "references (version-pinned config shapes), and an optional live layer via the"
  echo "Microsoft Learn MCP (https://learn.microsoft.com/api/mcp) for current docs."
  echo "The load-bearing canonical facts are in the Accuracy baseline; each skill"
  echo "repeats them so it stands alone."
  echo
  echo "============================================================"
